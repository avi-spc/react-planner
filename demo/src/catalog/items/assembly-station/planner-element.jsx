...
export default {
  ...
  info: {
    ...
    tag: ["electronics"],
    description: "assembly station",
    image: require("./AssemblyStation.png"),
  },
  ...
  render2D: function (element, layer, scene) {
    let width = { length: 1.6 * 4, unit: "ft" };
    ...
    return (
      <g
        transform={`rotate(${90}) translate(${-newWidth / 2},${
          -newDepth / 2
        }) `}
      >
        <rect
  ...
  render3D: function (element, layer, scene) {
    ...
    let mtl = require("./AssemblyStation.mtl");
    let obj = require("./AssemblyStation.obj");
