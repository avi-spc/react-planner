...
export default {
  ...
  info: {
    ...
    image: require("./StorageShelf.png"),
  },
  ...
  render2D: function (element, layer, scene) {
    let width = { length: 1.6 * 7.0, unit: "ft" };
    let depth = { length: 0.59 * 7.4, unit: "ft" };
    ...
    return (
      <g
        transform={`rotate(${90}) translate(${-newWidth / 2},${-newDepth / 2})`}
      >
        <rect
          key="1"
          x="0"
  ...
  render3D: function (element, layer, scene) {
    ...
    let mtl = require("./StorageShelf.mtl");
    let obj = require("./StorageShelf.obj");
