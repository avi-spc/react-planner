...
export default {
  name: "manual-workstation",
  prototype: "items",

  info: {
    title: "Manual Workstation",
    tag: ["furnishing", "electronics"],
    description: "manual workstation",
    image: require("./ManualWorkstation.png"),
  },
  ...
  render2D: function (element, layer, scene) {
    let width = { length: 1.6 * 5, unit: "ft" };
    let depth = { length: 0.59 * 4, unit: "ft" };
    ...
    return (
      <g transform={`translate(${-newWidth / 2},${-newDepth / 2})`}>
        ...
        <text
          ...
          x="0"
          y="0"
          transform={`translate(${(newWidth / 2)-35}, ${
            newDepth / 2
  ...
  render3D: function (element, layer, scene) {
    ...
    let onLoadItem = (object) => {
      ...
      object.scale.set(
        (newWidth * objScale) / width.length,
        (newHeight * objScale) / height.length,
        (newDepth * objScale) / depth.length
      );
    ...
    let mtl = require("./ManualWorkstation.mtl");
    let obj = require("./ManualWorkstation.obj");
